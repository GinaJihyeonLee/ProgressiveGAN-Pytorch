...
parser.add_argument('--log_root', type=str, default='/home/nas1_userE/jihyeonlee/study/pggan/tb')
...
parser.add_argument('--flag_equalized', type=bool, default=True)     # use of sigmoid at the end of the discriminator.
